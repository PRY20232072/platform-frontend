...
class ConsetService {
    ...
    getByRegisteryIdAndPractitionerId = (registerId: string, practitionerId: string) => {
        return http.get(`${consentPath}/register/${registerId}/practitioner/${practitionerId}`);
    }
    ...
    approveConsent = (registerId: string, practitionerId: string) => {
        return http.put(`${consentPath}/register/${registerId}/practitioner/${practitionerId}`);
    };

    revokeConsent = (registerId: string, practitionerId: string) => {
        return http.delete(`${consentPath}/register/${registerId}/practitioner/${practitionerId}`);
    };
};
